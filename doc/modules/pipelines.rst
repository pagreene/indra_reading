...
A pipeline that uses AWS Batch and caches on S3 (:py:mod:`indra_reading.pipelines.pmid_reading`)
------------------------------------------------------------------------------------------------
...
The machinery for reading a list of PMIDs with REACH or SPARSER (:py:mod:`indra_reading.pipelines.pmid_reading.read_pmids`)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. automodule:: indra_reading.pipelines.pmid_reading.read_pmids
    :members:
...
A pipeline that uses StarCluster (:py:mod:`indra_reading.scripts.starcluster_reading`)
--------------------------------------------------------------------------------------
